...
- **🔌 Anthropic MCP Registry REST API v0.1 Compatibility** - Full compatibility with Anthropic's MCP Registry REST API specification. [API Documentation](docs/anthropic_registry_api.md)
...
- **API Compatibility**: Full support for Anthropic's Registry REST API v0.1 specification - point your Anthropic API clients to this registry to discover available servers
...
| [Anthropic Registry API](docs/anthropic_registry_api.md)<br/>**NEW!** REST API v0.1 compatibility | [Fine-Grained Access Control](docs/scopes.md)<br/>Permission management and security | [Dynamic Tool Discovery](docs/dynamic-tool-discovery.md)<br/>Autonomous agent capabilities |
...
- **[#171 - Feature: Import Servers from Anthropic MCP Registry](https://github.com/agentic-community/mcp-gateway-registry/issues/171)** ✅ **COMPLETED**
  Anthropic MCP Registry import functionality implemented. Import curated servers with a single command and access through the gateway with full REST API v0.1 compatibility. [Import Guide](docs/anthropic-registry-import.md) | [API Documentation](docs/anthropic_registry_api.md)
