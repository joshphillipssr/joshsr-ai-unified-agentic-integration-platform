...
**Anthropic Registry REST API v0.1 Compatibility** (#178)
- **Full API Compatibility** - Complete support for Anthropic's Registry REST API v0.1 specification
...
- [Registry REST API v0.1 Documentation](docs/anthropic_registry_api.md) - API reference and examples
...
curl https://your-gateway/v0.1/servers \
...
- **REST API v0.1 Documentation** - Full API reference for Anthropic registry compatibility
